...
USE METRO;
create table metro_info(metro_id int not null,metro_name varchar(30) unique,
...
update metro_info set metro_number=876 where metro_id=13;
...
alter table metro_info add constraint metr_price_chk check(metros_price>=1000 
or metros_price<=100000000);
