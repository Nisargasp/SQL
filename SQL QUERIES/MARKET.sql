...
CREATE TABLE Market_info (
    ...
    OpeningDate DATE,
    Capacity INT, constraint capaci_chk check (Capacity>900),
    Ratings int, constraint rating_chk check (Ratings>2));

desc Market_info;

insert into Market_info values
(1,'KR Market', 'Bangalore', 'Bangalore Urban', 'Karnataka', '560002', 8099555040, 'Wholesale', '1928-01-01', 1000, 4),
